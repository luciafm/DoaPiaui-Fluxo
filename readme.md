...
* O projeto surge da necessidade de disponibilizar uma versão navegável e funcional do sistema, já que os alunos envolvidos originalmente não conseguiram concluir a integração do sistema, por isso, entregaram apenas um protótipo. Você pode conferir o repositório original do projeto contendo todos os códigos feitos pelos alunos aqui: https://github.com/luciafm/DoaPiaui
